  ...
  return (
    <div className="w-full rounded-lg bg-white p-6">
      <div className="flex h-[271px] gap-6">
        ...
        <div className="flex h-[271px] w-[calc(100%-518px)] flex-col justify-between">
          <div className="flex flex-col gap-[10px]">
            <div className="h-6 w-24 animate-pulse  rounded-md bg-gray-300" />
            <div className="h-8 w-48 animate-pulse  rounded-md bg-gray-300" />
            <div className="h-6 w-32 animate-pulse  rounded-md bg-gray-300" />
          </div>
          <button
            type="button"
            onClick={onRetry}
            className="mt-4 animate-pulse rounded-md bg-black px-4 py-2 font-bold text-white  hover:bg-black-10"
          >
            다시 시도 🔄
          </button>
        </div>
